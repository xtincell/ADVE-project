/**
 * Anti-drift CI test — Phase 18 (ADR-0054) `BRAND_NATURE_ARCHETYPES` cohérence.
 *
 ...
 *
 * Cf. [docs/governance/adr/0054-brand-nature-archetypes-template.md](../../../docs/governance/adr/0054-brand-nature-archetypes-template.md).
 */
