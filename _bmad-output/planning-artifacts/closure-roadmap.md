...
> **2026-07-01 ouverture #20-24 (refonte v3.3)** — les 5 cibles prévues par [refonte-v3.3/00-CADRE.md §0.12](../../docs/governance/refonte-v3.3/00-CADRE.md) + [ANNEXE-C §C.4](../../docs/governance/refonte-v3.3/ANNEXE-C-adr-tests.md) sont ouvertes au titre du mandat carte blanche opérateur 2026-07-01 ([ADR-0121](../../docs/governance/adr/0121-refonte-v33-fleet-execution.md), ratification = review de la PR porteuse, DEC-1). Exécution par flotte d'agents : [refonte-v3.3/EXECUTION.md](../../docs/governance/refonte-v3.3/EXECUTION.md). Les cibles #15/#18/#19 existantes sont couvertes par la même branche big-bang (E2 · E3+C6 · R8).
...
| **20** | **Refonte v3.3 — Chantier A « Grande Renomination »** (R1 Mestor→Sia · R2 Artemis→Neith · R3 Tarsis→Shaï · R4 Hunter→Wepwawet · R5 Jehuty⊂Notoria/Per-Ankh · R6 Yggdrasil→Arbre+Sève · R7 ZOMBIE→LATENT) + alias Classe P (`wire-aliases`) | Naming (alignement canon) | tous (renommage transverse) | cross-portal (routes renommées) | XL (≈370 fichiers src) | Indirect (cohérence doctrinale 7 sources) | **NOT_STARTED** | Spec : [refonte-v3.3 R1-R7](../../docs/governance/refonte-v3.3/00-CADRE.md) + ANNEXE-A/B. Zéro symbole Classe S legacy en `src/` (hors `@deprecated-wire`) ; `wire-alias-completeness` + `no-legacy-neter-symbol` + `neteru-coherence` HARD verts ; 7 sources v3.3 ; livré via branche `refonte/alignement-v3.3` (merge L4 unique). WP-A0..A8 ([EXECUTION.md](../../docs/governance/refonte-v3.3/EXECUTION.md)). |
| **21** | **Refonte v3.3 — E1 `PilotingRegime`** (5 crans × 5 plans ontologiques, plancher ADVE dur, gate `ADVE_FLOOR`, historique `PilotingRegimeChange` → ICP) | Delegation socle | Mestor→Sia (gate) | Cockpit (5 sliders) + Console (lecture flotte) | L | Direct (prérequis bloquant vente EFR — F-1) | **NOT_STARTED** | Spec : [E1](../../docs/governance/refonte-v3.3/E1-piloting-regime.md). ADR à créer (n° premier-libre, ex-0088 ANNEXE-C) ; `piloting-regime-floor.test.ts` HARD vert ; défaut ASSISTÉ au seed ; labels crans = DEC-2 (draft INFERRED admis). WP-A9. |
| **22** | **Refonte v3.3 — C1 EFR/Constat/ICP + C3 activation J0→J7 + C4 SLA** (+C5 amendement durci rattaché) | Contrat & activation | Sia (gates) · Thot (carburant) | Cockpit + Console | XL | **Direct** (obligation d'effet tracé = cœur de l'offre) | **NOT_STARTED** | Specs : [C1](../../docs/governance/refonte-v3.3/C1-efr-echec-icp.md)+[C3](../../docs/governance/refonte-v3.3/C3-activation-j0-j7.md)+[C4](../../docs/governance/refonte-v3.3/C4-sla.md)+[C5](../../docs/governance/refonte-v3.3/C5-amendement-adve.md). 3 ADRs neufs + amendement ADR-0023 ; `efr-recourse-mechanical` HARD ; Efr/ConstatAltitude hash-chaînés ; dépend #21 + #15. WP-A12/A14/A15/A16. |
| **23** | **Refonte v3.3 — C2 données & souveraineté + C9 PI & contrat-type** | Souveraineté & PI | Sia (gates) · Seshat (zone-legal) | Cockpit (consentement) + Console (matrice PI) | L | Chain (confiance contractuelle Afrique francophone) | **NOT_STARTED** | Specs : [C2](../../docs/governance/refonte-v3.3/C2-donnees-souverainete.md)+[C9](../../docs/governance/refonte-v3.3/C9-pi-contrat-type.md). 2 ADRs neufs ; `signal-pool-gate` + `no-pii-onchain` HARD ; `dataRegion` défaut africain (DEC-9) ; opt-in pool OFF défaut + k≥5. WP-A13/A20. |
| **24** | **Refonte v3.3 — C7 KPIs agence (méta-EFR) + C8 brownfield multi-marques** | Agence & brownfield | Thot · Seshat · Sia | Console (dashboard flotte) + Cockpit (portfolio) | L-XL | Chain (flotte pilotée comme marque — méta-isomorphisme OUI) | **NOT_STARTED** | Specs : [C7](../../docs/governance/refonte-v3.3/C7-console-kpis-agence.md)+[C8](../../docs/governance/refonte-v3.3/C8-brownfield-multi-marques.md). 2 ADRs neufs ; méta-EFR réutilise Efr+BrandMaturityScore scopés Agence ; palier d'entrée brownfield calculé (jamais LATENT forcé si masse) ; M&A reste hors scope (#10 trigger-locked). WP-A18/A19. |
...
### Condition 1 — All 24 targets resolved
...
_2026-07-01 by NEFER (session fondatrice revamp) — **cibles #20-24 ouvertes** (ledger 19 → 24 targets) au titre du mandat carte blanche opérateur, ratification en review de PR (DEC-1). Programme d'exécution par flotte d'agents livré : [refonte-v3.3/EXECUTION.md](../../docs/governance/refonte-v3.3/EXECUTION.md) (22 WP flux A big-bang + 10 WP flux B main-flow + 9 décisions flux C) + [FLEET-PROTOCOL](../../docs/governance/refonte-v3.3/FLEET-PROTOCOL.md) + [STATUS](../../docs/governance/refonte-v3.3/STATUS.md) + [ADR-0121](../../docs/governance/adr/0121-refonte-v33-fleet-execution.md). Baseline 2026-07-01 (`f8b4378`) : tsc 0 · eslint 0 erreur · governance 876/876 · madge 0 cycle. Cibles #15/#18/#19 : exécution absorbée par la branche big-bang (statuts inchangés jusqu'au merge L4)._
