/**
 * seed-rice-scales.ts — Barème RICE canon (Intercom) en LIGNES de référence.
 *
 * ADR-0109 : les valeurs des libellés RICE sont des données mutables, pas du
 * hardcode. Ce seed pose l'échelle canonique ; un opérateur peut l'ajuster en
 * base sans toucher au code. `buildRiceScaleRows()` est PUR (testable sans DB).
 */
