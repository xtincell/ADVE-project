  ...
  cockpit: [
    {
      ...
      body: "Ce sélecteur vous ramène au hub des portails à tout moment, sans perdre votre contexte.",
    ...
    },
    {
      ...
      body: "La barre latérale suit votre marque : Ma marque (fondation, stratégie, recommandations), Mes livrables, Mon activité, Mon marché et Mon compte.",
    ...
    },
    {
      ...
      body: "Sautez à n'importe quelle page, campagne ou livrable en tapant 2-3 lettres. C'est le raccourci le plus utilisé.",
    ...
    },
    {
      ...
      body: "L'assistant répond à vos questions sur votre marque et vous oriente vers la bonne page. Quand l'icône clignote, une recommandation vous attend.",
