...
> **ADRs liés** : [ADR-0052](../adr/0052-brand-tree-multi-archetype.md), [ADR-0053](../adr/0053-llm-as-ui-orchestrator-manual-first.md), [ADR-0054](../adr/0054-brand-nature-archetypes-template.md), [ADR-0055](../adr/0055-morning-brief-batch-validation.md)
...
### 1.1 — Modèle d'arbre marque (cf. ADR-0052)
...
**Livrables** :
- ADR-0052 (Brand Tree multi-archétype) ✅ shipped 2026-05-06
- ADR-0053 (LLM as UI orchestrator — manual-first parity) ✅ shipped 2026-05-06
- ADR-0054 (Brand Nature Archetypes template) ✅ shipped 2026-05-06
- ADR-0055 (Morning Brief Batch validation) ✅ shipped 2026-05-06
...
- ADR-0055 réf cross-check shipped J1
...
- Heuristiques anti-erreur (cf. ADR-0055 §7)
...
|---|---|---|---|---|
| **0052** | Brand Tree multi-archétype hiérarchique | 18-A0 | ✅ shipped 2026-05-06 | [adr/0052](../adr/0052-brand-tree-multi-archetype.md) |
| **0053** | LLM as UI orchestrator (manual-first parity) | Transverse | ✅ shipped 2026-05-06 | [adr/0053](../adr/0053-llm-as-ui-orchestrator-manual-first.md) |
| **0054** | `BRAND_NATURE_ARCHETYPES` cascade par nature | 18-A0 | ✅ shipped 2026-05-06 | [adr/0054](../adr/0054-brand-nature-archetypes-template.md) |
| **0055** | Morning Brief Batch — middle portal validation | 18-A1 | ✅ shipped 2026-05-06 | [adr/0055](../adr/0055-morning-brief-batch-validation.md) |
