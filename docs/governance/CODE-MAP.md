...
- `SESHAT_RECORD_EPREUVE` → scoreur (sync) — Scoreur à force révélée (ADR-0147) : enregistre UNE épreuve dyadique OBSERVÉE (a…
- `SESHAT_SCORE_BRAND` → scoreur (sync) — Scoreur à force révélée (ADR-0147) : estime la force θ ± RD par arène (Bradley-T…
