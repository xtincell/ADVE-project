/**
 * Backfill script: Phase 18 (ADR-0059) Brand Tree.
 *
 ...
 *
 * Cf. [docs/governance/adr/0059-brand-tree-multi-archetype.md](../docs/governance/adr/0059-brand-tree-multi-archetype.md) §3.
 */
...
async function main() {
  console.log(`\n${"=".repeat(70)}`);
  console.log(`Phase 18 (ADR-0059) — Backfill Brand Tree`);
