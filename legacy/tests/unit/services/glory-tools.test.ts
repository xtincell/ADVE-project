...
// ============================================================
// Registre des outils GLORY (40 legacy + 9 Phase 13 Oracle + 4 Phase 14 Imhotep + 3 Phase 15 Anubis = 56)
// ============================================================
describe("GLORY Tools — Registre", () => {
  it("doit contenir exactement 56 outils (40 legacy + 9 Phase 13 Oracle + 4 Phase 14 Imhotep + 3 Phase 15 Anubis)", () => {
    expect(ALL_GLORY_TOOLS).toHaveLength(56);
  });
...
// ============================================================
// 4 Layers avec distribution correcte (post Phase 14/15 — +4 Imhotep + 3 Anubis)
// ============================================================
describe("GLORY Tools — 4 Layers", () => {
  it("doit avoir 11 outils dans la couche CR (Concepteur-Redacteur, +1 Phase 15 ad-copy-generator)", () => {
    expect(getToolsByLayer("CR")).toHaveLength(11);
  });

  it("doit avoir 20 outils dans la couche DC (+9 Phase 13 Oracle + 2 Phase 14 talent-evaluator/qc-evaluator)", () => {
    // 9 legacy DC + 9 Phase 13 Oracle + 2 Phase 14 Imhotep (talent-evaluator, qc-evaluator)
    expect(getToolsByLayer("DC")).toHaveLength(20);
  });

  it("doit avoir 15 outils dans la couche HYBRID (+2 Phase 14 crew-matcher/formation-recommender + 2 Phase 15 audience-targeter/broadcast-scheduler)", () => {
    expect(getToolsByLayer("HYBRID")).toHaveLength(15);
  });
  ...
  it("la somme des layers doit egaliser 56 (40 legacy + 9 Phase 13 + 4 Phase 14 + 3 Phase 15)", () => {
    const total =
