# ADR-0055 — Morning Brief Batch — middle portal validation pour ingestion mail/slack

**Status** : Accepted (Phase 18-A1, post 18-A0)
**Date** : 2026-05-06
**Phase** : 18 — Matanga × FrieslandCampina × Brand Tree
**Supersedes** : aucun
**Related** : [ADR-0052](0052-brand-tree-multi-archetype.md) (Brand Tree — pré-requis pour brand-resolver tree-aware), [ADR-0053](0053-llm-as-ui-orchestrator-manual-first.md) (manual-first — invariant transverse), [ADR-0054](0054-brand-nature-archetypes-template.md) (cascade par nature — pour le matching nodePath), [ADR-0026](0026-mcp-bidirectional-anubis.md) (Anubis MCP bidirectionnel — pour auto-pull)
...
Combiné avec la directive Manual-first (cf. [ADR-0053](0053-llm-as-ui-orchestrator-manual-first.md)) :
...
// Extension Campaign existant (cf. ADR-0052 §9 déjà mentionné)
...
Cf. [ADR-0053 §8](0053-llm-as-ui-orchestrator-manual-first.md) — l'auto-confirm est une délégation explicite de l'opérateur, pas une violation Manual-first.
...
- [ ] `CHANGELOG.md` v6.18.15 entry mentionne ADR-0055 + Morning Brief Batch
