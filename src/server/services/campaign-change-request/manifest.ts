 ...
 *
 * Manual-first parity (ADR-0053) : routes tRPC `campaignChangeRequest.*`
...
export const manifest = defineManifest({
  ...
  docs: {
    summary:
      "CRUD CampaignChangeRequest + workflow escalation. 4 Intents Mestor. Cf. ADR-0052 §audit MATANGA V4 sheet TICKETS MODIFS.",
  },
  missionContribution: "GROUND_INFRASTRUCTURE",
  groundJustification:
