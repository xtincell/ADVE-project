/**
 * /launchpad/crew-bootstrap — Phase 18 (ADR-0052) crew Imhotep bootstrap.
 *
 ...
 *
 * Manual-first parity (ADR-0053) garantie : aucune création automatique
    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-6 p-6">
      <header>
        ...
        <p className="mt-1 text-sm text-foreground-secondary">
          Phase 18 (ADR-0052) — Pré-import de l'équipe créa Matanga confirmée 2026-05-06.
