...
/**
 * La Guilde — formulaire de dépôt de mission (marques). ADR-0098.
...
export function PostMissionForm() {
  ...
  // ── Assist LLM optionnel (ADR-0098) — pré-remplissage, le dirigeant corrige ──
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      {/* Assist IA — optionnel (ADR-0098). Le formulaire reste utilisable sans. */}
