...
import { CalendarRange, Wand2, Loader2, CalendarClock, X, Inbox, Rocket, CheckCircle2 } from "lucide-react";
        ...
        >
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              <span className={`text-xs font-semibold ${isExpanded ? "text-accent" : "text-foreground"}`}>
                {a.title}
              </span>
              {isAccepted && (
                <span className="rounded bg-success/15 px-1.5 py-0.5 text-[9px] font-bold text-success">
                  Généré
                </span>
              )}
            </div>
            ...
            <div className="flex justify-end pt-2 border-t border-white/5">
              {isAccepted ? (
                <div className="text-success font-semibold flex items-center gap-1">
                  <CheckCircle2 className="h-3.5 w-3.5" /> Campagne & Mission de production créées et planifiées
                </div>
              ) : (
                <button
                  type="button"
                ...
                >
                  ...
                  Déclencher Campagne & Production
                </button>
              )}
            </div>
          </div>
