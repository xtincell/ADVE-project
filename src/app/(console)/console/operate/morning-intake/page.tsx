/**
 * /console/operate/morning-intake — Phase 18-A1-δ (ADR-0055).
 *
 ...
 *
 * Manual-first parity (ADR-0053) : aucune fonction LLM-only. Toutes les actions
    ...
    <div className="flex flex-col gap-6 p-6">
      <header>
        ...
        <p className="mt-1 text-xs text-foreground-secondary">
          Operator : <strong>{operator.name}</strong>. Manual-first parity (ADR-0053) : tout est saisissable manuellement sans LLM.
        </p>
      </header>
