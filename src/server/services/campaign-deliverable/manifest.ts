/**
 * Manifest — campaign-deliverable (Phase 18, ADR-0052).
 *
 * 4 capabilities CRUD + RAG override pour `CampaignDeliverable` matrice 6D
 * gouvernées par MESTOR.
 *
 * Manual-first parity (ADR-0053) : 4 routes tRPC `campaignDeliverable.*`
...
export const manifest = defineManifest({
  ...
  docs: {
    summary:
      "CRUD CampaignDeliverable matrice 6D + RAG override. 4 Intents Mestor. Cf. ADR-0052 §8.",
  },
  missionContribution: "GROUND_INFRASTRUCTURE",
  groundJustification:
