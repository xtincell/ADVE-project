/**
 * CANON UPGRADERS — la stratégie « La Fusée — Industry OS » à 100 % sur les
 * 8 piliers, alignée champ par champ sur les contrats de maturité COMPLETE
 * (expectedKeys des schémas Zod). Source de vérité UNIQUE consommée par :
 *   - prisma/seed-upgraders.ts (DB fraîches / dev)
 ...
 * charges détaillé). RTIS inclus : pour la marque de l'agence elle-même,
 * les dérivés sont curés par l'opérateur (dogfooding, méta-isomorphisme
 * Ch.7 §7.3) — ils restent regénérables par la cascade comme tout satellite.
 */
...
export const UPGRADERS_STRATEGY_NAME = "La Fusée — Industry OS";
