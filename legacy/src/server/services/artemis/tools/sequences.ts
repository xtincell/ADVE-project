...
// Types de sequence extraits dans ./sequence-types (leaf) — rompt les cycles
// sequences ⇄ {adops-sequences, framework-wrappers, phase13-oracle-sequences} (madge).
export type {
  SequenceStepType,
  GlorySequenceFamily,
  GlorySequenceKey,
...
const NETERU_SEQUENCES: GlorySequenceDef[] = [
  // ── T0.5 CRYSTALLISATION ──────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      glory("competitive-analysis-builder", ["competitive_landscape"]),
    ],
    aiPowered: true,
    lifecycle: "DRAFT",
    tier: 0,
  ...
  // ── T3 CAMPAIGN ───────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      glory("campaign-360-simulator", ["campaign_simulation"]),
