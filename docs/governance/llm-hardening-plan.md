...
| **1** | PROD | **Verrou de sortie** : migrer les 55 outils + 52 appels directs vers `executeStructuredLLMCall` (schéma Zod). Sous-lots : **1a** quick-intake/brief-ingest/boot ; **1b** rtis-cascade/notoria/mestor-insights ; **1c** Glory concept ; **1d** Glory brand ; **1e** campaign-plan/vault-enrichment/reliquat. | ⬜ à venir |
