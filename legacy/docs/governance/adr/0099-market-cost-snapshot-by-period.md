# ADR-0099 — Base de coûts marché historisés (MarketCostSnapshot)

> **Renumérotation 2026-06-15** — créé `ADR-0094` sur la branche `galileo`, renommé `ADR-0099` lors de la consolidation `galileo` ↔ `focused-hypatia` (collision avec `ADR-0094` arrivé en premier le 2026-06-13, convention first-come-keep ; cf. test `adr-uniqueness`).
