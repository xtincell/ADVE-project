    ...
    <div className="space-y-6 p-6">
      ...
      <footer className="rounded-lg bg-surface-secondary p-4 text-xs text-foreground-secondary ring-1 ring-inset ring-border">
        ...
        <p className="mt-2">
          ...
          <a className="text-cyan-400 underline" target="_blank" rel="noreferrer" href="https://github.com/xtincell/ADVE-project/blob/main/docs/governance/adr/0058-anonymization.md">
            ADR-0052-F
          </a>{" "}
