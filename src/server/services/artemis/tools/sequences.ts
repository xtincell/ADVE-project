...
//
// Phase 13 sequence modules need GlorySequenceDef + SequenceStep but sequences
// also imports the phase sequence arrays. Moving the type definitions to a
// sibling `./types` file breaks the cycle: phase modules import from `./types`,
// sequences imports values from phase modules.
