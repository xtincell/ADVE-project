...
| `strategy-presentation/` | Assemblage Oracle 21 sections + catalogue `OracleError` (ADR-0014) | MESTOR | à créer |
| `strategy-presentation/error-codes.ts` | Catalogue typé `ORACLE-NNN` + classe `OracleError` + `toOracleError` (ADR-0014) | MESTOR | n/a (helper) |
