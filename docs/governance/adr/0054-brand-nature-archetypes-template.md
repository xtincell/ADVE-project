# ADR-0054 — `BRAND_NATURE_ARCHETYPES` — cascade hiérarchique par BrandNature

**Status** : Accepted (PRODUCT operable Phase 18-A0 ; 8 autres natures Phase 18-bis)
**Date** : 2026-05-06
**Phase** : 18 — Matanga × FrieslandCampina × Brand Tree
**Supersedes** : aucun
**Related** : [ADR-0052](0052-brand-tree-multi-archetype.md) (Brand Tree — l'enum `BrandNature` est défini ici), [ADR-0053](0053-llm-as-ui-orchestrator-manual-first.md), [ADR-0048](0048-glory-tools-as-primary-api-surface.md) (Glory tools applicables par nature)
...
- [ ] `CHANGELOG.md` v6.18.15 entry mentionne ADR-0054
