/**
 * Anti-drift CI test — Phase 18 (ADR-0052) Brand Tree cohérence schéma + ADR alignment.
 *
 * Vérifie que le schéma Prisma reflète bien les contraintes ADR-0052 :
 ...
 *
 * Cf. [docs/governance/adr/0052-brand-tree-multi-archetype.md](../../../docs/governance/adr/0052-brand-tree-multi-archetype.md).
 */
...
describe("brand-tree-coherence — schéma Prisma reflète ADR-0052", () => {
  ...
  it("BrandNode a tous les champs ADR-0052 §1.1", () => {
    const block = extractModelBlock(schema, "BrandNode");
  ...
  it("CampaignDeliverable a tous les champs matrice 6D ADR-0052 §8", () => {
  ...
  it("Campaign a workflow dual + RAG (extension ADR-0052 §9)", () => {
  ...
  it("enum BrandNature contient les 9 valeurs canoniques (ADR-0054)", () => {
...
describe("brand-tree-coherence — ADR-0052 référencé dans NEFER + plan", () => {
  it("ADR-0052 file existe", () => {
    const adrPath = join(__dirname, "../../../docs/governance/adr/0052-brand-tree-multi-archetype.md");
  ...
  it("ADR-0053 (manual-first) référencé dans ADR-0052", () => {
    const adr0052 = readFileSync(
      join(__dirname, "../../../docs/governance/adr/0052-brand-tree-multi-archetype.md"),
      "utf-8",
    );
    expect(adr0052).toContain("ADR-0053");
