/**
 * La Guilde — portail public (ADR-0098).
 *
...
export const laGuildeRouter = createTRPCRouter({
   ...
   * UPgraders au besoin (ADR-0098, modèle « Shell Strategy auto »). La mission
  ...
  /**
   * Assist LLM OPTIONNEL (ADR-0098) — pré-remplissage du brief depuis une
