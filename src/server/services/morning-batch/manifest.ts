/**
 * Manifest — morning-batch (Phase 18-A1-δ, ADR-0055).
 *
 * 7 capabilities CRUD + workflow ingestion mail/slack avec middle portal validation.
 * Manual-first parity (ADR-0053) : 2 capabilities `OPERATOR_CREATE_INGESTED_SOURCE`
...
export const manifest = defineManifest({
  ...
  capabilities: [
    ...
    },
    {
      ...
      idempotent: true,
      missionContribution: "GROUND_INFRASTRUCTURE",
      groundJustification: "Édition manuelle d'un draft pendant le middle portal review (Manual-first parity ADR-0053).",
    },
    {
    ...
    },
    {
      ...
      idempotent: false,
      missionContribution: "GROUND_INFRASTRUCTURE",
      groundJustification: "Saisie manuelle d'une source (mail/slack/whatsapp) sans LLM. Manual-first parity ADR-0053.",
    },
    {
      ...
      idempotent: false,
      missionContribution: "GROUND_INFRASTRUCTURE",
      groundJustification: "Saisie manuelle d'un brief draft sans LLM. Manual-first parity ADR-0053.",
    },
  ],
  dependencies: [],
  docs: {
    summary:
      "Morning Brief Batch ingestion mail/slack/whatsapp avec middle portal validation humaine. 7 Intent kinds. Manual-first parity (saisie manuelle alternative pour chaque LLM action). Cf. ADR-0055.",
  },
  missionContribution: "DIRECT_SUPERFAN",
  groundJustification:
