/**
 * Manifest — brand-node (Phase 18, ADR-0052).
 *
 ...
 *
 * Manual-first parity (ADR-0053) : les 6 Intents sont aussi exposés via
...
export const manifest = defineManifest({
  ...
  docs: {
    summary:
      "Brand Tree CRUD multi-archétype. 6 Intents Mestor + helper validateNodeTransition (BRAND_NATURE_ARCHETYPES). Validation runtime NATURE_TRANSITION_VALIDITY. Cf. ADR-0052.",
  },
  missionContribution: "GROUND_INFRASTRUCTURE",
  groundJustification:
