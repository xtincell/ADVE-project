 ...
 *
 * Manual-first parity (ADR-0053) : routes tRPC `operatorAction.*` consommables
...
export const manifest = defineManifest({
  ...
  docs: {
    summary:
      "CRUD OperatorAction (sub-tâches transverses) + toggle done. 4 Intents Mestor. Cf. ADR-0052 §audit MATANGA V4 sheet ACTIONS.",
  },
  missionContribution: "GROUND_INFRASTRUCTURE",
  groundJustification:
